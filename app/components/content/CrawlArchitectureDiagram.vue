<template>
  <div class="crawl-architecture my-8">
    ...
    >
      ...
      >Phase 1 — schema discovery (once per shop)</text>
      ...
      <text
        ...
        :fill="subtitleColor"
        font-family="sans-serif"
      >Phase 2 — production crawl (no LLM)</text>
      ...
      <text
        ...
        font-family="sans-serif"
        opacity="0.85"
      >renders full page, raw HTML</text>
      ...
      <text
        ...
        font-family="sans-serif"
        opacity="0.85"
      >generates CSS schema from HTML</text>
      ...
      <text
        ...
        font-family="sans-serif"
        opacity="0.85"
      >CSS extraction, zero LLM calls</text>
      ...
      <text
        ...
        font-family="sans-serif"
        opacity="0.85"
      >normalize price, name, URLs</text>
      ...
      <text
        ...
        font-family="sans-serif"
        opacity="0.85"
      >products indexed, ready to search</text>
